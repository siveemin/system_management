...
export function Card({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div className={cn("rounded-2xl bg-white dark:bg-slate-900 border shadow-sm", className)} {...props}>
      {children}
    </div>
  );
}
...
export function CardTitle({ className, children, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return (
    <h3 className={cn("text-sm font-bold text-slate-900 dark:text-slate-100", className)} {...props}>
      {children}
    </h3>
  );
}
